...
print_info "Verificando base de datos Ecommerce..."
ECOMMERCE_DB_READY=$(docker exec entrepreneur-postgres-ecommerce pg_isready -U vendure 2>&1 | grep "accepting connections" || echo "")

if [ -z "$ECOMMERCE_DB_READY" ]; then
    print_error "La base de datos Ecommerce no está lista."
    print_info "Ejecuta: docker-compose up -d postgres-ecommerce"
...
echo ""
echo "================================================"
echo -e "${GREEN}🎉 ¡Vendure Ecommerce configurado exitosamente!${NC}"
echo "================================================"
echo ""
...
echo ""
echo -e "${BLUE}Resumen completo del sistema:${NC}"
echo ""
echo "Vendure Master:"
...
echo "  - API: http://localhost:3002/shop-api"
