...
### Method 2: Sequential Installation (Ecommerce Only)

**Recommended for:** Low-RAM systems, focused development, or step-by-step setup

- **Script:** `setup-vendure-ecommerce.sh` (Linux/macOS) or `setup-vendure-ecommerce.ps1` (Windows)
- **Installs:** ONLY vendure-ecommerce instance
- **RAM Required:** ~4GB
- **Duration:** 3-5 minutes
- **Best for:** Resource-constrained machines, installing after vendure-master
- **Prerequisite:** vendure-master must already be installed

**Note:** If using Method 2, ensure vendure-master is already installed using `setup-vendure-master.sh/.ps1`.
...
**Option 2: Sequential Installation (ecommerce only)**
```bash
# From project root
./tools/scripts/setup-vendure-ecommerce.sh
...
| **Install (ecommerce only)** | `./tools/scripts/setup-vendure-ecommerce.sh` or `pnpm run setup:vendure:ecommerce` | `.\tools\scripts\setup-vendure-ecommerce.ps1` or `pnpm run setup:vendure:ecommerce` |
